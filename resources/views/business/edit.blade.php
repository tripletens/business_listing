...
@section('content')
    <div class="jumbotron text-center">
        <h1>Admin Edit Business Page </h1>
        <p> This is the Admin Edit Business Page </p>
        <div class="container-fluid ">
            <div class="row">
                ...
                <div class="col-md-4">
                    <form method="POST" action="{{ route('update-business',$business->id)}}"  enctype="multipart/form-data">
                        @csrf
                        @include('inc.messages')
                        <h4> You are updating <b>{{ $business->name }}</b></h4>
